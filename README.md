About pyslet-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyslet-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=922&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyslet-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyslet` can be installed with `conda`:
...
```
mamba install pyslet
```

It is possible to list all of the versions of `pyslet` available on your platform with `conda`:
...
```
mamba search pyslet --channel conda-forge
```
...
mamba repoquery search pyslet --channel conda-forge

# List packages depending on `pyslet`:
mamba repoquery whoneeds pyslet --channel conda-forge

# List dependencies of `pyslet`:
mamba repoquery depends pyslet --channel conda-forge
```
